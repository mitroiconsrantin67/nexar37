// Validări pentru aplicația Nexar
// Acest fișier conține validări pentru diferite părți ale aplicației

// Lista de dotări permise pentru motociclete
...
// Lista de mărci permise pentru motociclete
...
// Categorii permise cu imaginile lor
export const ALLOWED_CATEGORIES = [
  ...
  {
    name: "Adventure",
    image: "https://www.advpulse.com/wp-content/uploads/2016/04/Honda-XRE-300-a-561x373.jpg",
  },
  {
    name: "Naked",
